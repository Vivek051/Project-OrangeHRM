...
public class OrangeHRMTestCases extends Basetest {
	...
	public Object[][] loginDataProvider1() throws IOException {
		String path = "C:\\Users\\vivek\\git\\Project_OrangeHRM\\Capsotne_ProjectOrangeHRM\\data.xlsx";
	...
	public Object[][] addUserDataProvider() throws IOException {
		String path = "C:\\Users\\vivek\\git\\Project_OrangeHRM\\Capsotne_ProjectOrangeHRM\\adduser_data.xlsx";  // Use new file
	...
	public Object[][] employeeSearchDataProvide() throws IOException {
		String path = "C:\\Users\\vivek\\git\\Project_OrangeHRM\\Capsotne_ProjectOrangeHRM\\SearchEmployee.xlsx";
		return Excelutilities.getdata(path, "Sheet1");
	}

	@DataProvider(name = "projectdata")
	public Object[][] projectdata() throws IOException {
		String path = "C:\\Users\\vivek\\git\\Project_OrangeHRM\\Capsotne_ProjectOrangeHRM\\\\projectdata.xlsx";
		return Excelutilities.getdata(path, "Sheet1");
	}
